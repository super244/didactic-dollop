#!/usr/bin/env python3
"""Dataset Preparation Script for rtx_pro_6000"""
...
class DatasetPreparer:
    ...
    def generate_dataset(self) -> List[Dict[str, str]]:
        ...
        logger.info(f"Generating {size} problems for rtx_pro_6000")
        problems = []
...
def main():
    parser = argparse.ArgumentParser(description="Prepare dataset for rtx_pro_6000")
