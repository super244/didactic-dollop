#!/usr/bin/env python3
"""Dataset Preparation Script for 4x_b200"""
...
class DatasetPreparer:
    ...
    def generate_dataset(self) -> List[Dict[str, str]]:
        ...
        logger.info(f"Generating {size} problems for 4x_b200")
        problems = []
...
def main():
    parser = argparse.ArgumentParser(description="Prepare dataset for 4x_b200")
